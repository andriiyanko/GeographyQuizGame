...
public class CustomAdapterWaterFalls extends BaseAdapter {

    private Context context;
    private List<RankingWaterFalls> lstRaniking;

    public CustomAdapterWaterFalls(Context context, List<RankingWaterFalls> lstRaniking) {
