...
import java.util.List;
    ...
    public class CustomAdapterCities extends BaseAdapter {

    private Context context;
    private List<RankingCities> lstRaniking;

    public CustomAdapterCities(Context context, List<RankingCities> lstRaniking) {
